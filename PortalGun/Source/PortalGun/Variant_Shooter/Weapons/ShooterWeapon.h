 ...
 */
UCLASS(abstract)
class PORTALGUN_API AShooterWeapon : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	/** If true, the weapon is currently firing its secondary fire mode */
	...
	// If true, this weapon has a secondary fire mode
...
public:
	...
	// Start firing this weapon's secondary fire mode
	void StartSecondaryFire();

	// Stop firing this weapon's secondary fire mode
...
protected:
	...
	// Fire the weapon's secondary fire mode
	...
	// Fire a secondary projectile towards the target location
